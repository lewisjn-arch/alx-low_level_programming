...
/**
 * check_elf - This statement checks if a file is an ELF file.
...
/**
 * print_magic - This statement Prints the magic numbers of an ELF header.
 * @e_ident: pointer to array containing the ELF magic numbers.
 *
...
/**
 * print_class - This statement Prints the class of an ELF header.
...
/**
 * print_data - This statement Prints the data of an ELF header.
 * @e_ident: pointer to array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 *  * print_version - This statement prints the version of an ELF header.
...
/**
 * print_osabi - This statement prints the OS/ABI of an ELF header.
 * @e_ident: pointer to array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
